      ...
      >
        ...
        {started && (
          <div className="bvControls" onClick={e => e.stopPropagation()}>
            ...
            <div className="bvBar">
              <button className="bvBtn" onClick={togglePlay} title={playing ? t('media.pause') : t('media.play')}>
                {playing
              ...
              <div className="bvBarRight">
                <button className="bvBtn" onClick={toggleMute} title={muted ? t('media.unmute') : t('media.mute')}>
                  {muted
                ...
                <button className="bvBtn" onClick={goFullscreen} title={t('media.fullscreen')}>
