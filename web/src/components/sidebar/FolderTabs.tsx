...
export function FolderTabs({
  ...
  const BUILT_IN = [
    { id: 'all',    label: t('folderTabs.all') },
    { id: 'direct', label: t('folderTabs.direct') },
    { id: 'groups', label: t('folderTabs.groups') },
  ] as const;
  ...
  return (
    <div className="folderTabsWrap">
      ...
      >
        ...
        {/* Add folder button */}
        <button className="folderAddBtn" onClick={onCreateFolder} title={t('common.createFolder')}>
