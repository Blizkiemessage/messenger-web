  ...
  return (
    <div className="modalOverlay" onClick={e => e.target === e.currentTarget && !removeConfirm && onClose()}>
      <div className="groupInfoCard">
          ...
          {editing ? (
            <div className="giEditForm">
              ...
              <div className="giEditTextareaWrap">
                <textarea className="giEditTextarea" value={editDesc} onChange={e => setEditDesc(e.target.value.slice(0, DESC_MAX))}
        ...
        {/* Description section (outside header, below) */}
        {!editing && desc && (
          <div className="giDescSection">
            <div className="giDescLabel">Описание группы</div>
            <div className="giDesc">{descShown}</div>
            {descNeedsExpand && (
